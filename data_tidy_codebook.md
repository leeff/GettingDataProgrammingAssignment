...
2. "activity_label": 
  ...
  * STANDING
  * LAYING
3. Finally, 66 variables on average of the estimated mean and standard deviation features for these 17 signals taken for each unique set of subject and activity:
...
## Naming of the 66 variables
"avg_" + *signal* + "_mean|_stdDev" + optionally "_X", "_Y" or "_Z" to denote direction.

## the 66 variable names
